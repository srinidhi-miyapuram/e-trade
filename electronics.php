...
<body>
 ...
 ?>
  ...
  <div class="body">
    ...
    <div class="block">
      <table>
        ...
        $check1 = $_POST['mobile'];
        $check2 = $_POST['laptop'];
        $check3 = $_POST['headset'];
        $test1 = (isset($check1) == true);
        $test2 = (isset($check2) == true);
        $test3 = (isset($check3) == true);

        if ((empty($check1) && empty($check2) && empty($check3)) || (!empty($check1) && !empty($check2) && !empty($check3))) {
    ...
    <?php
        ...
        if (isset($sub) == true) {
          if ($test1 && $test2 && $test3) {
            ...
            $sql = "SELECT * FROM products WHERE subcategory='mobile' OR subcategory='laptop' OR subcategory='headset'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='mobile' OR subcategory='laptop'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='mobile' OR subcategory='headset'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='laptop' OR subcategory='headset'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='laptop'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE  subcategory='headset'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {

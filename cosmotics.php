...
?>
  ...
  <div class="body">
    <div class="side">
      <div class="bar">
        <form action="cosmotics.php" method="post">
          <div class="input">
            <input type="checkbox" name="makeup" value="makeup"> Makeup
          </div>
          <div class="input">
            <input type="checkbox" name="lipstick" value="lipstick"> Lipstick
          </div>
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='cream'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='lipstick'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {

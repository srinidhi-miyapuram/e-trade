...
<body>
 ...
 ?>
    ...
    <div class="side">
      <div class="bar">
        <form action="shoe.php" method="post">
          ...
          <div class="input">
            <input type="checkbox" name="sandle" value="sandle"> Sandle
          </div>
    ...
    <?php
        ...
        if (isset($sub) == true) {
          if ($test1 && $test2) {
            ...
            $sql = "SELECT * FROM products WHERE subcategory='shoe' OR subcategory='sandle'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='shoe'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
  ...
  <?php
            ...
            $sql = "SELECT * FROM products WHERE subcategory='sandle'";
            $query = mysqli_query($con, $sql);
            $row = mysqli_num_rows($query);
            $count = 0;
            if ($row > 0) {
